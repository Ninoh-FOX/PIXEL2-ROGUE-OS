...
def get_valid_ss_systems():
    valid_systems = [
        ...
        "TG16","TG16CD","TIC-80","UZEBOX","VARCADE","VECTREX","VIC20","VIDEOPAC","VIRCON32","VIRTUALBOY",
